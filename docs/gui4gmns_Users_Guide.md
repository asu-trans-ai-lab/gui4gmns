...
gui4gmns is the cross-platform successor of the NEXTA GUI for viewing AMS (Analysis–Modeling–Simulation)
...
gui4gmns reads the same GMNS files afterward.
